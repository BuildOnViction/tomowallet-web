...
const setGlobalStorage = (key, object) => {
...
export const setLocale = (locale) => setGlobalStorage("locale", locale);
export const getLocale = () => getGlobalStorage("locale");
export const removeLocale = () => removeGlobalStorage("locale");
