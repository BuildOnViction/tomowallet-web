...
import { DEPOSIT_PRIVACY_FIELDS, PORTFOLIO_COLUMNS } from '../../../constants';
// ===================
    ...
    return (
      <div className='box-confirmation'>
        ...
        <Row>
          ...
          <Col xs={8} className=''>
            {`${removeTrailingZero(
              _get(formValues, [DEPOSIT_PRIVACY_FIELDS.TRANSFER_AMOUNT]),
            )} ${_get(
              formValues,
        ...
        <Row>
          ...
          <Col xs={8}>
            {`${removeTrailingZero(
              _get(formValues, [DEPOSIT_PRIVACY_FIELDS.TRANSACTION_FEE, 'amount']),
