...
export default defineMessages({
  ...
  COMMON_LIST_LANGUAGE_TURKISH: {
    id: `${listPrefix}.language.turkish`,
  ...
  MY_WALLET_TABLE_PORTFOLIO_CELL_ACTION_VIEW_WRAP_APP: {
    id: `${myWalletPagePrefix}.table.portfolio.cell.action.viewwrapapp`,
    defaultMessage: "Wrap/Unwrap {token} on TomoBridge",
  },
